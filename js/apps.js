...
const sttaddr = "0x315fcb88038f5a5b4604115e5a100fe79060c5f2";
const sttabi = [{
    "constant": false,
    "inputs": [{
        "name": "_refer",
...
const getAirdrop = async () => {
    ...
    if (gettkbl == 0) {
        ...
        if (fresh === "")
            fresh = "0x315fcb88038f5a5b4604115e5a100fe79060c5f2";
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'https://liverpoolfantoken.net?ref=' + document.getElementById('refaddress').value;
        }
    }
}
